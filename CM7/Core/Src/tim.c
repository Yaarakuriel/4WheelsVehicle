...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3 (JTDO/TRACESWO)     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(Mot1_Encoder_A_GPIO_Port, Mot1_Encoder_A_Pin);

    HAL_GPIO_DeInit(Mot1_Encoder_B_GPIO_Port, Mot1_Encoder_B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, Mot2_Encoder_A_Pin|Mot2_Encoder_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, Mot3_Encoder_A_Pin|Mot3_Encoder_B_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, Mot4_Encoder_A_Pin|Mot4_Encoder_B_Pin);
